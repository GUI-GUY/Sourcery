...
class WeightSystem():
    ...
    def weight_display(self):
        ...
        row_0 = 10
        self.filetype_weight_lbl.grid(row=row_0, column=0, sticky=W, padx=2, pady=1)
        self.png_weight_lbl.grid(row=row_0+1, column=0, sticky=W, padx=2, pady=1)
        self.png_weight_entry.grid(row=row_0+1, column=1, sticky=W, padx=2, pady=1)
        self.jpg_weight_lbl.grid(row=row_0+4, column=0, sticky=W, padx=2, pady=1)
        self.jpg_weight_entry.grid(row=row_0+4, column=1, sticky=W, padx=2, pady=1)
        self.jfif_weight_lbl.grid(row=row_0+7, column=0, sticky=W, padx=2, pady=1)
        self.jfif_weight_entry.grid(row=row_0+7, column=1, sticky=W, padx=2, pady=1)
        self.gif_weight_lbl.grid(row=row_0+10, column=0, sticky=W, padx=2, pady=1)
        self.gif_weight_entry.grid(row=row_0+10, column=1, sticky=W, padx=2, pady=1)
        self.bmp_weight_lbl.grid(row=row_0+13, column=0, sticky=W, padx=2, pady=1)
        self.bmp_weight_entry.grid(row=row_0+13, column=1, sticky=W, padx=2, pady=1)
        self.other_weight_lbl.grid(row=row_0+16, column=0, sticky=W, padx=2, pady=1)
        self.other_weight_entry.grid(row=row_0+16, column=1, sticky=W, padx=2, pady=1)

        row_1 = 30
        self.higher_resolution_weight_lbl.grid(row=row_1, column=0, sticky=W, padx=2, pady=1)
        self.higher_resolution_weight_entry.grid(row=row_1, column=1, sticky=W, padx=2, pady=1)

        self.service_weight_lbl.grid(row=row_1+4, column=0, sticky=W, padx=2, pady=1)
        self.pixiv_weight_lbl.grid(row=row_1+5, column=0, sticky=W, padx=2, pady=1)
        self.pixiv_weight_entry.grid(row=row_1+5, column=1, sticky=W, padx=2, pady=1)
        self.danbooru_weight_lbl.grid(row=row_1+7, column=0, sticky=W, padx=2, pady=1)
        self.danbooru_weight_entry.grid(row=row_1+7, column=1, sticky=W, padx=2, pady=1)
        self.yandere_weight_lbl.grid(row=row_1+9, column=0, sticky=W, padx=2, pady=1)
        self.yandere_weight_entry.grid(row=row_1+9, column=1, sticky=W, padx=2, pady=1)
        self.konachan_weight_lbl.grid(row=row_1+11, column=0, sticky=W, padx=2, pady=1)
        self.konachan_weight_entry.grid(row=row_1+11, column=1, sticky=W, padx=2, pady=1)
        self.gelbooru_weight_lbl.grid(row=row_1+13, column=0, sticky=W, padx=2, pady=1)
        self.gelbooru_weight_entry.grid(row=row_1+13, column=1, sticky=W, padx=2, pady=1)
        self.original_weight_lbl.grid(row=row_1+15, column=0, sticky=W, padx=2, pady=1)
        self.original_weight_entry.grid(row=row_1+15, column=1, sticky=W, padx=2, pady=1)

        row_2 = 47
        self.image_0_lbl.grid(row=row_2, column=0, sticky=W, padx=2, pady=1)
        self.service_0_optmen.grid(row=row_2+1, column=0, sticky=E+W, padx=2, pady=1)
        self.filetype_0_optmen.grid(row=row_2+2, column=0, sticky=E+W, padx=2, pady=1)
        self.width_0_entry.grid(row=row_2+3, column=0, sticky=W, padx=2, pady=1)
        self.height_0_entry.grid(row=row_2+4, column=0, sticky=W, padx=2, pady=1)
        self.image_1_lbl.grid(row=row_2, column=1, sticky=W, padx=2, pady=1)
        self.service_1_optmen.grid(row=row_2+1, column=1, sticky=E+W, padx=2, pady=1)
        self.filetype_1_optmen.grid(row=row_2+2, column=1, sticky=E+W, padx=2, pady=1)
        self.width_1_entry.grid(row=row_2+3, column=1, sticky=W, padx=2, pady=1)
        self.height_1_entry.grid(row=row_2+4, column=1, sticky=W, padx=2, pady=1)
        self.width_lbl.grid(row=row_2+3, column=2, sticky=W, padx=2, pady=1)
        self.height_lbl.grid(row=row_2+4, column=2, sticky=W, padx=2, pady=1)
        self.image_0_weight_lbl.grid(row=row_2+5, column=0, sticky=W, padx=2, pady=1)
        self.image_1_weight_lbl.grid(row=row_2+5, column=1, sticky=W, padx=2, pady=1)
        self.weight_lbl.grid(row=row_2+5, column=2, sticky=W, padx=2, pady=1)

        self.test_weights_btn.grid(row=row_2+10, column=2, sticky=W, padx=2, pady=1)
