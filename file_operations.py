...
def save(chkbtn_vars_array, chkbtn_vars_big_array, pixiv_images_array, delete_dirs_array, safe_to_show_array, frame, process):
    ...
    for i in range(len(pixiv_images_array)):
            ...
            for img in chkbtn_vars_big_array[index]:
                ...
                if img[1].get() == 1:
                    try:
                        ...
                        gv.Files.Log.write_to_log("ERROR [0016] " + str(e))
        ...
        #     gv.Files.Log.write_to_log("ERROR [0015] " + str(e))
...
#         gv.Files.Log.write_to_log("ERROR [0010] " + str(e))
...
#         gv.Files.Log.write_to_log("ERROR [0011] " + str(e))
...
# def gv.Files.Log.write_to_log(message = ''):
#     global log
#     if log == -1:
#         try:
